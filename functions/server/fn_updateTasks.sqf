...
private _captureSides = _trigger getVariable "grad_flagsector_captureSides";
private _owner = _trigger getVariable "grad_flagsector_currentOwner";
private _previousOwner = _trigger getVariable "grad_flagsector_previousOwner";
private _lockAfterCapture = _trigger getVariable "grad_flagsector_lockAfterCapture";

private _sectorName = _trigger getVariable "grad_flagsector_sectorName";
...
if (_lockAfterCapture) then {
    {
        _task = _trigger getVariable (format ["grad_flagsector_task_%1",_x]);
