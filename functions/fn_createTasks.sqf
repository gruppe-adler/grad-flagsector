...
private _captureSides = _trigger getVariable "grad_sector_captureSides";
private _owner = _trigger getVariable "grad_sector_currentOwner";
...

{
    ...
    _task = [_x,format ["grad_sector_task_%1_%2",_x,getPos _trigger],_description,getPos _trigger,true,1,false,_marker,true] call BIS_fnc_taskCreate;

    _trigger setVariable [format ["grad_sector_task_%1",_x],_task];
    false
} count _captureSides;
